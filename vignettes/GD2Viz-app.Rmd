...
> ⚠️ Make sure your input files are properly formatted. The metadata file can include experimental variables such as subtype, treatment, or batch for later grouping and analysis.
...
The **Global Plot Settings** panel lets you choose which adjusted RAS type to visualize and allows you to group plots by any experimental variable defined in your metadata.
...
1. **RAS Heatmap**
   ...
   * Customize row/column labels, scaling, clustering method, and distance metrics.
   
<img src="images/tab3_4.png" align="center" width="60%"/>

2. **Promoting vs. Diminishing Reactions Scatter Plot**

   * Summarizes the balance of GD2-promoting vs. GD2-diminishing reactions used by the SVM model.
...
* **Ganglioside Pathway Visualization**:
  Provides a detailed graphical analysis of ganglioside-specific reactions, including network-style views of reaction changes.

---

### Differential Expression Analysis (DEA)

The final section mirrors the functionality of the **TCGA Project View** tab. Users can perform DEA using GD2 score-based stratification:
